...
const logs: LogItem[] = [
  {
    ...
    cameraId: "0",
    detailedDesc:
      "Multi-vehicle collision reported at Bay Bridge. Multiple cars involved. Emergency services dispatched. Traffic backed up for 2 miles. Lane closures in effect.",
  },
  {
    id: "2",
    severity: "high",
    ...
    cameraId: "1",
    detailedDesc:
      "Pedestrian struck by vehicle near Golden Gate Bridge. Victim is conscious but injured. Ambulance en route. Scene is being secured by traffic control.",
  },
  {
    id: "3",
    severity: "medium",
    ...
    cameraId: "2",
    detailedDesc:
      "Heavy traffic congestion due to rush hour. Vehicles moving slowly. No incidents detected. Expected to clear in 30 minutes.",
  },
  {
    id: "4",
    severity: "medium",
    ...
    cameraId: "3",
    detailedDesc:
      "Vehicle stalled on right lane. Driver is safe and awaiting assistance. Roadside assistance has been notified. Minor traffic delay.",
  },
  {
    id: "5",
    severity: "low",
    ...
    cameraId: "4",
    detailedDesc:
      "Traffic conditions are normal. All lanes are flowing smoothly. No incidents reported in this area.",
  },
  {
    id: "6",
    severity: "low",
    ...
    cameraId: "5",
    detailedDesc:
      "Dense fog advisory in effect. Reduced visibility for drivers. Speed reduction recommended. Please use caution.",
  },
  {
    id: "7",
    severity: "low",
    ...
    cameraId: "6",
    detailedDesc:
      "Construction zone active. Lane shift in effect. Workers present. Slow down to 25 mph. Expected completion in 2 hours.",
  },
];
...
function LogDetailPage() {
  ...
  const camera = log?.cameraId ? cameras[parseInt(log.cameraId)] : undefined;
                  ...
                  <Grid.Col span={12}>
                    <Stack gap="xs">
                      ...
                      <Text c={camera.in_service ? "green" : "red"}>
                        Status:{" "}
                        {camera.in_service ? "In Service" : "Out of Service"}
                      </Text>
                    </Stack>
                  </Grid.Col>
                </Grid>
