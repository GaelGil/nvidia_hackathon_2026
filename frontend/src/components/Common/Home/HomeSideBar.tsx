        ...
        <ScrollArea style={{ flex: 1 }} px="sm">
          <Stack gap="sm" pb="md">
            ...
            <Flex align="center" gap="xs" px={4}>
              ...
              <Text fz="xs" c="dimmed">
                {agentReady
                  ? "Nemotron agent online"
                  : "Agent offline — set NVIDIA_API_KEY"}
              </Text>
            </Flex>
            ...
            {incidents.length === 0 && !loading && !error && (
              <Box px={4} mt={8}>
                ...
                <Text fz="xs" c="dimmed" ta="center" mt={4}>
                  Click a camera on the map and press <b>Scan with Nemotron</b>,
                  or start the monitoring loop.
                </Text>
                {!monitoring && (
                  <Button
                    mt="md"
              ...
              >
                <Card
                  ...
                  style={{
                    ...
                    background: "#0a0a0a",
                    borderColor:
                      SEVERITY_COLOR_MAP[log.severity] === "red"
                        ? "#ff4444"
                        : SEVERITY_COLOR_MAP[log.severity] === "orange"
                          ? "#ffaa00"
                          : "#00cc66",
                  }}
                >
